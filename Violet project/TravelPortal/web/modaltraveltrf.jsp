<%-- 
    Document   : modaltraveltrf
    Created on : 12.05.2012, 10:11:38
...
<div id="editTravelTrfModal" class="modal hide fade" style="width: 750px; margin: -250px 0 -0 -380px;">
    <div class="modal-header">
        <meta name="author" content="Allan (base by Vlad)">
        <a href="#" class="close" onclick="$('#editTravelTrfModal').modal('hide')">&times;</a>
        <h3>
