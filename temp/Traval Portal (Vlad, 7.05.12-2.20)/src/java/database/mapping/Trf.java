...
public class Trf implements java.io.Serializable {
    ...
    public Trf(long id, Customer customer, Destination destination, Employee employeeByProjectManager, Employee employeeByEmpId, Date beginDate, Date endDate, Boolean carRental, Boolean payByCash, Short curState, Set<Trfstate> trfstates) {
        this.id = id;
