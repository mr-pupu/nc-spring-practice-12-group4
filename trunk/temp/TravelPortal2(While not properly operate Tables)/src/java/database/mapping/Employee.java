...
public class Employee  implements java.io.Serializable {
    ...
    public Employee(long id, Occupation occupation, Office office, Department department, String firstName, String secondName, String email, String login, String password, Set<Trf> trfsForEmpId, Set<Trf> trfsForProjectManager) {
       this.id = id;
