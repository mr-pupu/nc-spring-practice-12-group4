    	...
    	<div class="accordion" id="accordion2">
            <div class="accordion-group">
              <div class="accordion-heading">
                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">
                  <h4><%=locale.getString("page.employee.text1")%></h4>
                </a>
              </div>
	      ...
	      <table class="table table-bordered table-condensed">
	        <thead>
	          <tr>
	            <th style="width: 20px;">
	            	<button type="submit" class="btn btn-mini span1"><%=locale.getString("page.employee.buttonAdd")%></button>
	            </th>
	            <th><%=locale.getString("table.trfs.destination")%></th>
	            <th><%=locale.getString("table.trfs.dateBegin")%></th>
	            <th><%=locale.getString("table.trfs.dateEnd")%></th>
	            <th><%=locale.getString("table.trfs.status")%></th>
	            <th><%=locale.getString("table.trfs.comment")%></th>
	          </tr>
	        </thead>
	        <tbody>
	          <tr>
	          <tr>
	            <td>
	            	<a data-toggle="modal" href="#myModal" class="btn btn-mini span1"><%=locale.getString("page.employee.buttonEdit")%></a>
				</td>
            ...
            <div class="accordion-group">
              <div class="accordion-heading">
                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo">
                  <h4><%=locale.getString("page.employee.text2")%></h4>
                </a>
              </div>
	      ...
	      <tbody>
	          <tr>
	            ...
	            <td>From <input type="text">XX</td>
	            <td>To <input type="text">XX</td>
	          </tr>
	        </tbody>
	       </table>
